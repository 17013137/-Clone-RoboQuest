...
HRESULT CSky::SetUp_Components()
{
	...
	/* For.Com_Texture */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Texture"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Texture_SkyBox"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;	

	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_VIBuffer_Cube"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CSky::SetUp_ConstantTable()
{
	...
	if (FAILED(m_pTextureCom->SetUp_ShaderResourceView(m_pShaderCom, "g_DiffuseTexture", m_ImageIndex)))
		return E_FAIL;
