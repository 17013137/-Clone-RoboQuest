...
CLoadingBar::CLoadingBar(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
...
_int CLoadingBar::Tick(_double TimeDelta)
{
	...
	m_pTransformCom->Turn(XMVectorSet(0.f, 0.f, 1.f, 0.f), TimeDelta*2.f);

	return 0;
}

void CLoadingBar::LateTick(_double TimeDelta)
{
...
HRESULT CLoadingBar::SetUp_Components()
{
	/* For.Com_Renderer */
...
CLoadingBar * CLoadingBar::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CLoadingBar*	pInstance = new CLoadingBar(pDeviceOut, pDeviceContextOut);
