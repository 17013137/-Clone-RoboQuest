#include "stdafx.h"
#include "..\Public\Trail_Monster.h"
#include "GameInstance.h"

CTrail_Monster::CTrail_Monster(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{
}

CTrail_Monster::CTrail_Monster(const CTrail_Monster & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTrail_Monster::NativeConstruct_Prototype()
{
...
HRESULT CTrail_Monster::NativeConstruct(void * pArg)
{
...
_int CTrail_Monster::Tick(_double TimeDelta)
{
...
void CTrail_Monster::LateTick(_double TimeDelta)
{
...
HRESULT CTrail_Monster::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CTrail_Monster::SetUp_ConstantTable()
{
...
CTrail_Monster * CTrail_Monster::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CTrail_Monster*	pInstance = new CTrail_Monster(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CTrail_Monster"));
...
CGameObject * CTrail_Monster::Clone(void * pArg)
{
	CTrail_Monster*	pInstance = new CTrail_Monster(*this);
