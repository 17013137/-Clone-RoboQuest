#include "stdafx.h"
#include "..\Public\BulletCount.h"
#include "GameInstance.h"
#include "Player_Manager.h"
#include "Event_Manager.h"

CBulletCount::CBulletCount(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{
}

CBulletCount::CBulletCount(const CBulletCount & rhs)
	: CGameObject(rhs)
	, m_ProjMatrix(rhs.m_ProjMatrix)	
{
}

HRESULT CBulletCount::NativeConstruct_Prototype()
{
...
HRESULT CBulletCount::NativeConstruct(void * pArg)
{
...
_int CBulletCount::Tick(_double TimeDelta)
{
...
void CBulletCount::LateTick(_double TimeDelta)
{
...
void CBulletCount::Update_BulletInfo()
{
...
HRESULT CBulletCount::SetUp_Components()
{
	/* For.Com_Renderer */
...
CBulletCount * CBulletCount::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CBulletCount*	pInstance = new CBulletCount(pDeviceOut, pDeviceContextOut);
